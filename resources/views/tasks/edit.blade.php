...
@section('content')
    <div class="container mx-auto p-6 flex justify-center">
        <div class="bg-white shadow-lg rounded-lg p-8 w-full max-w-lg">
            <h1 class="text-2xl font-semibold mb-6 text-center text-gray-800">Edit Task</h1>
            ...
            <form action="{{ route('tasks.update', $task) }}" method="POST" class="space-y-6">
                ...
                <div>
                    ...
                    <input type="text" name="title" id="title"
                           class="border border-gray-300 p-3 rounded w-full shadow-sm focus:outline-none focus:ring-2 focus:ring-green-400"
                ...
                <div>
                    ...
                    <textarea name="description" id="description"
                              class="border border-gray-300 p-3 rounded w-full h-32 shadow-sm focus:outline-none focus:ring-2 focus:ring-green-400"
                ...
                <div class="flex justify-between items-center pt-4">
                    <button type="submit"
                            class="bg-green-500 hover:bg-green-600 text-white font-semibold py-2 px-6 rounded shadow-md transition-transform transform hover:scale-105">
                        Save Changes
                    </button>
